 ...
 * TODO 暫定対応
 * <P>タイトル : ディスパッチクラス</P>
 * <P>説明 : 収録情報編集画面を表示するクラスです。</P>
 */
@WebServlet("/DspPtcgEditExpansion")
public class DspPtcgEditExpansion extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DspPtcgEditExpansion() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//収録情報編集画面 にページ遷移
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/ptcg/PtcgEditExpansion.jsp");
